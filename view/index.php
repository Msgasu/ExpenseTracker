...
<body>
    ...
    <section>
        <section class="left">
            ...
            <div class="buttons">
                <a href="../login/login_page.php" class="btn">Log In</a> <!-- Changed link to anchor tag -->
                <a href="../login/register_page.php" class="btn">Sign Up</a> <!-- Changed link to anchor tag -->
            </div>
        </section>
